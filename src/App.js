  ...
  return <div>
    <BrowserRouter>
      <div className='flex relative dark:bg-main-dark-bg'>
        ...
        {activeMenu ? (
          <div className='w-72 fixed sidebar dark:bg-seconday-dark-bg bg-white'>Sidebar</div>
        ) : (
        ...
        <div className={
          ...
          <div className='fixed md:static bg-main-bg dark:bg-main-dark-bgg navbar w-full'>
            Navbar
          </div>
        </div>
